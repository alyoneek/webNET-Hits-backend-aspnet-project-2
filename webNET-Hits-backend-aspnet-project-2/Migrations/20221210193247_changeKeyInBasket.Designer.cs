...
namespace webNETHitsbackendaspnetproject2.Migrations
{
    ...
    [Migration("20221210193247_changeKeyInBasket")]
    partial class changeKeyInBasket
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("webNET_Hits_backend_aspnet_project_2.Models.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2022, 12, 10, 19, 32, 47, 108, DateTimeKind.Utc).AddTicks(152));
